...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-users"></i> User</h1>
</div>
            ...
            <div class="card-body">
                ...
                ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" <?= isset($nama)?"value='$nama'":''; ?> required >
                        </div>
                    </div>
                    <div class="form-group row">
